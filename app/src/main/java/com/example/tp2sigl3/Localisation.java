...
public class Localisation extends AppCompatActivity implements OnMapReadyCallback, Callback<DirectionsResponse>, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this,"sk.eyJ1IjoieWFvcGFyZmFpdCIsImEiOiJja2xiNHp2dWwwM2xuMnFtMXMwdHl2cm1hIn0.3Y5S7GM7GoEHMFB8AbOMag" );
        ...
        if (intent != null){
            if (intent.hasExtra("latitude") && intent.hasExtra("longitude")){
                ...
                titre = intent.getStringExtra("titreLieu");
                Toast.makeText(this, "latitude:"+latitude+", longitute:"+longitude, Toast.LENGTH_SHORT).show();
            }
            else{
                latitude = 5.291208;
                longitude = -3.998615;
                titre = "ESATIC Abidjan";
    ...
    public void onMapReady(final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                addUserLocations();
                Drawable drawable = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_localisation_vert, null);
                ...
                origin = Point.fromLngLat(-3.998615, 5.291208);
                source = point;
    ...
    private void reverseGeocodeFunc(LatLng point,int c)
    {
        MapboxGeocoding reverseGeocode = MapboxGeocoding.builder()
                .accessToken("sk.eyJ1IjoieWFvcGFyZmFpdCIsImEiOiJja2xiNHp2dWwwM2xuMnFtMXMwdHl2cm1hIn0.3Y5S7GM7GoEHMFB8AbOMag")
        ...
        reverseGeocode.enqueueCall(new Callback<GeocodingResponse>() {
            ...
            public void onResponse(Call<GeocodingResponse> call, Response<GeocodingResponse> response) {
                ...
                if (results.size() > 0) {
                    ...
                    Toast.makeText(Localisation.this, "" + feature.placeName(), Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Localisation.this, "Not found", Toast.LENGTH_SHORT).show();
                }
            }
...
// Add the red marker icon image to the map
        loadedMapStyle.addImage(RED_PIN_ICON_ID, BitmapUtils.getBitmapFromDrawable(
                getResources().getDrawable(R.drawable.ic_localistion_noir)));
...
// You can get the generic HTTP info about the response
        if (response.body() == null) {
            Toast.makeText(Localisation.this, "NO routes found make sure to set right user and access token", Toast.LENGTH_LONG).show();
            return;
        } else if (response.body().routes().size() < 1) {
            Toast.makeText(Localisation.this, "NO routes found", Toast.LENGTH_LONG).show();
        }
...
// reset the GeoJSON source for the route LineLayer source
    ...
    public void confirmed(View view){
        ...
        Intent i =new Intent(Localisation.this,Localisation.class);
        ...
        findViewById(R.id.fab_location_search).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        .accessToken(Mapbox.getAccessToken() != null ? Mapbox.getAccessToken() : "sk.eyJ1IjoieWFvcGFyZmFpdCIsImEiOiJja2xiNHp2dWwwM2xuMnFtMXMwdHl2cm1hIn0.3Y5S7GM7GoEHMFB8AbOMag")
...
// its placeName, text, or coordinates.
    ...
    private void enableLocationComponent(@NonNull Style loadedMapStyle) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(Localisation.this)) {
            ...
            locationComponent.activateLocationComponent(
                    LocationComponentActivationOptions.builder(Localisation.this, loadedMapStyle).build());

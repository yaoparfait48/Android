...
public class Rencontre extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    //le drawer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            navigationView.setCheckedItem(R.id.nav_renc);
        }

...
public class SiteReligieuxFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_sites_religieux, container, false);
        initUI(v);
        return v;
    }
    ...
    private void initUI(View v) {
        ...
        searchInput = v.findViewById(R.id.edit_text_search_religieux);//Bar de recherche

        recyclerView = v.findViewById(R.id.recy_site_rlg);
        dbHelper = new DBHelper(this.getContext());
        listT = dbHelper.recupereSite("Religion");
